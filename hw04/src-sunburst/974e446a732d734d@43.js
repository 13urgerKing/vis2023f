...
md` # HW 4 Simple & Medium baseline`
)}
  ...
  svg
    ...
    .on("mouseover", (_evt, d) => {
      if(d.data.name === "減少包裝材及文宣印製") {
        ...
        tooltip
        .style("opacity", 1)
        .html(`節約能源<br><?xml version="1.0" encoding="iso-8859-1"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="64px" height="64" viewBox="0 0 297.001 297.001" xml:space="preserve"><g><g><g><g><circle style="fill:#17AB93;" cx="148.5" cy="148.5" r="148.5"/></g></g></g><path style="fill:#107A66;" d="M296.832,141.521l-87.226-87.248L88.401,243.603l53.234,53.234c2.276,0.104,4.564,0.164,6.866,0.164c82.014,0,148.5-66.486,148.5-148.5C297,146.16,296.939,143.834,296.832,141.521z"/><g><path style="fill:#ECF0F1;" d="M82.5,66v165l0,0c0,9.113,7.387,16.5,16.5,16.5h99c9.113,0,16.5-7.387,16.5-16.5l0,0V66H82.5z"/></g><g><path style="fill:#BDC3C7;" d="M198,82.5H99c-9.113,0-16.5-7.387-16.5-16.5l0,0c0-9.113,7.387-16.5,16.5-16.5h99c9.113,0,16.5,7.387,16.5,16.5l0,0C214.5,75.113,207.113,82.5,198,82.5z"/></g><g><g><circle style="fill:#345F41;" cx="125.75" cy="66" r="4"/></g><g><circle style="fill:#345F41;" cx="140.917" cy="66" r="4"/></g><g><circle style="fill:#345F41;" cx="156.083" cy="66" r="4"/></g><g><circle style="fill:#345F41;" cx="171.25" cy="66" r="4"/></g></g><g><rect x="135" y="120.75" style="fill:#5D7486;" width="27" height="13.5"/></g><g><path style="fill:#2ECC71;" d="M131.875,231h33.25c4.487,0,8.125-3.638,8.125-8.125v-82.75c0-4.487-3.638-8.125-8.125-8.125h-33.25c-4.487,0-8.125,3.638-8.125,8.125v82.75C123.75,227.362,127.388,231,131.875,231z"/></g></g></svg>`)
        .style("border-color", color(d.data.name));
      }
      else
      {
...
<h2> 從圖中的資料可以看出</h2>
<ul>
  <li>大多數人藝術工作者會透過減少包裝來減少碳排放</li>
  <li>大多數人藝術工作者會比較傾向在工作室工作</li>
  <li>美術館的藝術工作者會比較傾向於透過節約能源來減少碳排放</li>
</ul>`
)}
...
d3
  ...
  .range(["#ae95ff","#5ddbbd","#a6d571","#8c33d3","#bf8138","#5d8f4f"])
  .unknown("#cccccc")
)}
