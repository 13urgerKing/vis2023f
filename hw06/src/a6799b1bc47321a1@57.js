...
__query(FileAttachment("artistPublic.csv"),{select:{columns:null},from:{table:"artistPublic"},filter:[],sort:[],slice:{from:null,to:null}},invalidation)
)}

function _artistver(__query,FileAttachment,invalidation){return(
__query(FileAttachment("artistVer.csv"),{select:{columns:null},from:{table:"artistVer"},filter:[],sort:[],slice:{from:null,to:null}},invalidation)
)}
